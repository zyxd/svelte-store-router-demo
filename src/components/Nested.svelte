...
<section in:fly={{ y: 200 }}>
  ...
  <Matcher>
    <Match path={$route.path} pattern="/nested/subpage1" loose>
      <section in:fly={{ y: 200 }}>
        <div>
        ...
        <Matcher>
          <Match path={$route.path} pattern="/nested/subpage1/subpage1">
            <section in:fly={{ y: 200 }}>
              subpage 1 of subpage 1
            </section>
          </Match>
          <Match path={$route.path} pattern="/nested/subpage1/subpage2">
            <section in:fly={{ y: 200 }}>
    ...
    <Match path={$route.path} pattern="/nested/subpage2" loose>
      <section in:fly={{ y: 200 }}>
        <div>
        ...
        <Matcher>
          <Match path={$route.path} pattern="/nested/subpage2/subpage1">
            <section in:fly={{ y: 200 }}>
              subpage 1 of subpage 2
            </section>
          </Match>
          <Match path={$route.path} pattern="/nested/subpage2/subpage2">
            <section in:fly={{ y: 200 }}>
